...
const Button = ({ icon = "", displayText = "WATCH NOW" }) => {
  return (
    <button className="flex items-center justify-center h-fit bg-button rounded-full gap-1 md:gap-1.5 lg:gap-2 px-3 py-1.5 md:px-4 md:py-2 lg:px-5 lg:py-2.5 hover:bg-bg-button">
